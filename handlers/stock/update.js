...
module.exports = function (req, res, next) {
        ...
        .input('itemno', sql.NVarChar, req.body.itemno)
		    .query('UPDATE dbo.Stock SET LASTSER#1 = @lastser, PERIOD#1 = @period, SERNO = @serno, STATUS = @status, PATTEST = @pattest, PATPERIOD = @patperiod, PATLASTSER = @patlastser, PATPERTYPE = @patpertype WHERE ITEMNO = @itemno')
